...
require_once("Setting/pageCodes.php");
 if (isset($_REQUEST["pageCode"])){
     $pageCodeValue = filterChosenContent($_REQUEST["pageCode"]);
 }
 else{
     $pageCodeValue=0;
 }
...
<head>
    ...
    <title> <?php echo returnConverted( $siteTitle); ?> </title>
    <meta name="description" content=" <?php echo  returnConverted($siteDescription); ?>">
    <meta name="keyword" content=" <?php echo  returnConverted($siteKeywords); ?>">
...
<!-- Header -->
    ...
    <div class="container-menu-desktop">
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <!-- Logo desktop -->
                <a href="index.php?pageCode=0" class="logo">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        <li class="active-menu">
                            <a href="index.php?pageCode=0">Home</a>
                            <ul class="sub-menu">
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="index.php"><img src="static/images/icons/logo-01.png" alt="IMG-LOGO"></a>
        </div>
...
<?php
if ((!$pageCodeValue) or ($pageCodeValue=="")or ($pageCodeValue==0)){
    include($pageNum[0]);
}
else{
      include($pageNum[$pageCodeValue]);
}
?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <li class="p-b-10">
                    <a href="index.php?pageCode=1" class="stext-107 cl7 hov-cl1 trans-04">
                        Hakkımızda
                ...
                <li class="p-b-10">
                    <a href="index.php?pageCode=2" class="stext-107 cl7 hov-cl1 trans-04">
                        Banka hesaplarımız
                    </a>
                </li>

                <li class="p-b-10">
                    <a href="index.php?pageCode=3" class="stext-107 cl7 hov-cl1 trans-04">
                        Havale Bildirim Formu
                    </a>
                </li>
                <li class="p-b-10">
                    <a href="index.php?pageCode=4" class="stext-107 cl7 hov-cl1 trans-04">
                        Kargo Nerde
                    </a>
                </li>

                <li class="p-b-10">
                    <a href="index.php?pageCode=5" class="stext-107 cl7 hov-cl1 trans-04">
                        İletişim
                    </a>
                </li>
                </ul>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="index.php?pageCode=6" class="stext-107 cl7 hov-cl1 trans-04">
                            Griş Yap
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="index.php?pageCode=7" class="stext-107 cl7 hov-cl1 trans-04">
                            Yeni Üye Ol
                        </a>
                    </li>
                    ...
                    <li class="p-b-10">
                        <a href="index.php?pageCode=8" class="stext-107 cl7 hov-cl1 trans-04">
                            Sık Sorulan Sorular
                        </a>
                    </li>
                </ul>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    ...
                    <li class="p-b-10">
                        <a href="index.php?pageCode=9" class="stext-107 cl7 hov-cl1 trans-04">
                            Üyelik Sözleşmesi
                        </a>
                    </li>
                    <li class="p-b-10">
                        <a href="index.php?pageCode=10" class="stext-107 cl7 hov-cl1 trans-04">
                            Kullanım  Koşulları
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="index.php?pageCode=11" class="stext-107 cl7 hov-cl1 trans-04">
                            Gizlilik Sözleşmesi
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="index.php?pageCode=12" class="stext-107 cl7 hov-cl1 trans-04">
                            Mesafeli Satış Sözleşmesi
                        </a>
                    </li>
                    <li class="p-b-10">
                        <a href="index.php?pageCode=13" class="stext-107 cl7 hov-cl1 trans-04">
                            Teslimat
                        </a>
                    </li>
                    <li class="p-b-10">
                        <a href="index.php?pageCode=14" class="stext-107 cl7 hov-cl1 trans-04">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <div class="p-t-27">
                    <a href="index.php?pageCode=" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
        ...
        <div class="p-t-40">
            ...
            <p class="stext-107 cl6 txt-center">
                ...
                Telif Hakkı  &copy;<script>document.write(new Date().getFullYear());</script>
           <?php echo returnConverted($siteCopyright);?>;     Elektronik Hizmetler Tic. A.Ş. Her Hakkı Saklıdır. | Made with <i class="fa fa-heart-o" aria-hidden="true"></i>
            </p>
        </div>
    </div>
</footer>
